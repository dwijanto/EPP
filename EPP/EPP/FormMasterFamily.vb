...
Public Class FormMasterFamily
    ...
    Public Sub LoadData()
        ...
        If DbAdapter1.GetDataSet(sqlstr, DS, mymessage) Then
            ...
            idx(0) = DS.Tables(0).Columns("familyid")
            DS.Tables(0).PrimaryKey = idx

            DS.Tables(0).Columns("familyid").AutoIncrement = True
            DS.Tables(0).Columns("familyid").AutoIncrementSeed = -1
            DS.Tables(0).Columns("familyid").AutoIncrementStep = -1
