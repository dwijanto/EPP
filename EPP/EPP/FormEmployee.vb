...
Public Class FormEmployee
    ...
    Public Sub LoadData()
        ...
        sqlstr = "select e.*,m.sn || ' ' || m.givenname as managername from shop.employee e left join shop.employee m on m.employeenumber = e.manager order by employeenumber asc;"
        If DbAdapter1.GetDataSet(sqlstr, DS, mymessage) Then
            DS.Tables(0).TableName = "Employee"

            Dim idx(0) As DataColumn
            idx(0) = DS.Tables(0).Columns("employeenumber")
    ...
    Private Sub ToolStripButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton2.Click
        If Not IsNothing(BS.Current) Then
            Dim myform = New FormInputEmployee(BS, False)
            If Not myform.ShowDialog() = Windows.Forms.DialogResult.OK Then
                BS.CancelEdit()
            End If
        Else
    ...
    Private Sub ToolStripButton4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton4.Click
        ...
        If Not IsNothing(ds2) Then
            ...
            If DbAdapter1.EmployeeTX(Me, mye) Then
