...
Public Class FormItemMustBeSold

    Private Property sqlstr As String
    Private DS As DataSet
    Private BS As BindingSource
    Private ItemBS As BindingSource
    ...
    Public Sub LoadData()
        ...
        sqlstr = "select i.refno,d.descriptionname,ibs.id from shop.itemmustbesold ibs" &
                 " left join shop.item i on i.itemid = ibs.id" &
                 " left join shop.description d on d.descriptionid = i.descriptionid;" &
                 " select i.refno,d.descriptionname,i.itemid from shop.item i" &
                 " left join shop.description d on d.descriptionid = i.descriptionid" &
                 " order by refno;"
        If DbAdapter1.GetDataSet(sqlstr, DS, mymessage) Then
            DS.Tables(0).TableName = "IBS"
            ...
            ItemBS.DataSource = DS.Tables("Item")
    ...
    Private Sub ToolStripButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton1.Click
        ...
        Dim myform = New FormInputItemMustBeSold(DS, BS)
    ...
    Private Sub ToolStripButton4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton4.Click
        ...
        If Not IsNothing(ds2) Then
            ...
            If DbAdapter1.ItemMustBeSoldTx(Me, mye) Then
