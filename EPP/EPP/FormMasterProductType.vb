...
Imports System.Text
Public Class FormMasterProductType
    ...
    Public Sub LoadData()
        ...
        sqlstr = " select producttypeid,producttypename from shop.producttype order by producttypename;"
        ...
        If DbAdapter1.GetDataSet(sqlstr, DS, mymessage) Then
            ...
            DS.Tables(0).Columns("producttypeid").AutoIncrement = True
            DS.Tables(0).Columns("producttypeid").AutoIncrementSeed = -1
            DS.Tables(0).Columns("producttypeid").AutoIncrementStep = -1
    ...
    Private Sub ToolStripButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton1.Click
        ...
        Dim myform = New FormInputproducttype(BS)
    ...
    Private Sub ToolStripButton4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton4.Click
        ...
        If Not IsNothing(ds2) Then
            ...
            If DbAdapter1.producttypeTx(Me, mye) Then
