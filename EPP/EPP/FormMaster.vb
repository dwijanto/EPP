...
Imports System.Text
Public Delegate Function Action(ByRef sender As Object, ByRef e As EventArgs) As Boolean
Public Delegate Function dbAdapterTx(ByRef sender As Object, ByRef e As ContentBaseEventArgs) As Boolean

Public Class FormMaster
    Public Property DS As DataSet
    Public Property BS As BindingSource
    Public Property CM As CurrencyManager
    Public Property Sqlstr As String
    Public Property TableName As String
    Public Property FieldId As String
    Public Property FormInput As Object
    Public Property myDbAdapterTx As dbAdapterTx
    Public Property InitDataGridView As Action
    Public Property UpdateAction As Action
    Public Property AddAction As Action
    ...
    Public Sub LoadData()
        ...
        'sqlstr = " select familyid,familyname from shop.family order by familyname;"
        ...
        If DbAdapter1.GetDataSet(sqlstr, DS, mymessage) Then
            ...
            'idx(0) = DS.Tables(0).Columns(FieldId) 'familyid
            'DS.Tables(0).PrimaryKey = idx

            'DS.Tables(0).Columns(FieldId).AutoIncrement = True
            'DS.Tables(0).Columns(FieldId).AutoIncrementSeed = -1
            'DS.Tables(0).Columns(FieldId).AutoIncrementStep = -1
            ...
            InitDataGridView.Invoke(DataGridView1, New EventArgs)
    ...
    Private Sub ToolStripButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton1.Click
        ...
        'Dim myform = New FormInputFamily(BS)
    ...
    Private Sub ToolStripButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton2.Click
        If Not IsNothing(BS.Current) Then
            UpdateAction.Invoke(sender, e)
            'Dim myform = New FormInputMaster(BS)
    ...
    Private Sub ToolStripButton4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton4.Click
        ...
        If Not IsNothing(ds2) Then
            ...
            ' If DbAdapter1.FamilyTx(Me, mye) Then
            If myDbAdapterTx.Invoke(Me, mye) Then
