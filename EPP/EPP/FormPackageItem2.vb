...
Public Class FormPackageItem2
    ...
    Public Sub DoLoad()
        ...
        SB.Append(String.Format("select s.packagename,s.mainitem,s.active,s.promotionalitem,s.id,i.refno,d.descriptionname from shop.packagename s" &
    ...
    Private Sub ToolStripButton4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton4.Click
        ...
        'MessageBox.Show(HDBS.Current.row.item("mainitem"))
        If Me.validate() Then
            'MessageBox.Show(HDBS.Current.row.item("mainitem"))
            HDBS.EndEdit()
            DTLBS.EndEdit()
