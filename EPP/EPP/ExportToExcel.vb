...
Public Class ExportToExcelFile
    ...
    Public Property FormatReportCallback As FormatReportDelegate = AddressOf formatreport
    ...
    Public Sub New(ByRef Parent As Object, ByRef querylist As List(Of QueryWorksheet), ByRef Directory As String, ByRef ReportName As String, ByVal FormatReportCallBack As FormatReportDelegate, ByVal PivotCallback As FormatReportDelegate, ByVal mytemplate As String)
        Me.QueryList = querylist
        Me.Directory = Directory
        Me.ReportName = ReportName
        Me.Parent = Parent
    ...
    Public Sub New(ByRef Parent As Object, ByRef querylist As List(Of QueryWorksheet), ByRef Directory As String, ByRef ReportName As String)
        Me.QueryList = querylist
        Me.Directory = Directory
        Me.ReportName = ReportName
        Me.Parent = Parent        
    ...
    Function CreateExcel(ByRef filename As String) As Boolean
    ...
    Private Function GenerateReport(ByRef FileName As String, ByRef errorMsg As String, ByVal dataset1 As DataSet) As Boolean
        ...
        Try
            ...
            'DATA
            Dim availrecord As Boolean = False
            ...
            Else
                ...
                For i = 0 To QueryList.Count - 1
                    ...
                    ProgressReport(2, "Get records..")
                    If myquery.Location <> "" Then
                        FillWorksheet(oSheet, myquery.Sqlstr, myquery.Location)
                    Else
            ...
            FileName = ValidateFileName(FileName, FileName & "\" & String.Format("Report" & ReportName & "-{0}-{1}-{2}.xlsx", Today.Year, Format("00", Today.Month), Format("00", Today.Day)))
